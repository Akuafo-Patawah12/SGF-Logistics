...
const FAQsAccordion = (props) => {
  ...
  return (
        ...
        <div style={{background:"#eee",borderRadius:"5px", width:"95%",border:"1px solid #ddd",borderBottom:"5px solid #eee", marginInline:"auto", height:`${accordion?"auto":"50px"}`,overflow:'hidden', animation:`${accordion?"animate 0.3s ease-in":"animateDown 0.3s ease-out"}`}}>
