...
const showAccordion=()=>{
  ...
  return (
    <div style={{minHeight:`${Accordion ? "130px":"50px"}`,paddingBottom:"10px"}}>
    <button onClick={showAccordion} style={{height:"40px",lineHeight:"1.5rem"}}><span style={{fontSize:"18px"}}>{props.header}</span><span style={{color:"white", rotate:`${Accordion ? "90deg":"0deg"}`}}><RightOutlined/></span></button>
